              ...
              <div className='container mx-auto px-[5%] lg:px-0 translate-y-[-20px] md:translate-y-[-70px] flex flex-col md:flex-row gap-2 md:gap-10'>
                <div className='flex gap-3 '>
                  {user?.photoURL ?
                    ...
                    :
                    <div className='h-[100px] md:h-[250px] w-[100px] md:w-[250px] rounded-full border-[10px] border-white bg-[green] flex justify-center items-center text-[36px] md:text-[90px] font-[600] text-white'>{user?.userInfo?.displayName[0]}</div>
                  }
                </div>
