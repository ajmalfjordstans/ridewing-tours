      ...
      >
        ...
        >
          <AnimatePresence mode='wait'>
            {showSignIn ? (
              <motion.div
                className='bg-custom-red py-[20px] md:py-[70px] flex flex-col justify-center items-center text-white gap-2'
                initial={{ x: -100, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                exit={{ x: -100, opacity: 0 }}
                transition={{ duration: 0.5 }}
              ...
              <motion.div
                className='py-[20px] md:py-[70px] flex flex-col justify-center items-center text-white gap-2'
                initial={{ x: 100, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                exit={{ x: 100, opacity: 0 }}
                transition={{ duration: 0.5 }}
