...
export default function TourHero({ data }) {
  ...
  return (
    <>
        ...
        <div>
          ...
          <div className='flex gap-4 flex-wrap mt-[12px] font-bold text-[15px] leading-[18px]'>
            ...
            <div className='flex items-center gap-2 '>
              ...
              <p>{Array.isArray(bookingPackage?.details?.language) ? bookingPackage?.details?.language[0] : bookingPackage?.details?.language}</p>
            </div>
          </div>
        </div>
        <div>
          <div className='flex items-end gap-2'>
            ...
            <p className='font-bold text-[30px]'>{bookingPackage?.currency}{bookingPackage?.bulkPrice ? bookingPackage?.bulkPrice.toLocaleString() : bookingPackage?.price.toLocaleString()}</p>
          </div>
          <Button
      ...
      {/* Timeline {bookingPackage?.name} */}
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-[30px] mt-[50px]'>
        <div className='w-full flex flex-col pt-[40px] rounded-[15px] shadow-2xl px-[30px]'>
          <p className='font-bold text-[26px] md:text-[32px] leading-[42px]'> Itinerary</p>
          <div className='h-[1px] w-full bg-[#00000080] mt-[20px]'>
            <div className='h-[3px] w-[320px] bg-[#E4322C] translate-y-[-1.5px]'></div>
          </div>
          <div className=" text-[16px] leading-[36px] max-w-[700px] max-h-[80vh] overflow-y-scroll no-scrollbar mx-auto mt-[70px]">
                ...
                {bookingPackage?.itinerary?.itinerary.map((stop, id) => {
                  return (
                    <TimelineItem key={id} >
                      ...
                      <TimelineBody className="pb-0 translate-y-[-45px]">
                        <p color="blue-gray">
                          {stop}
                        </p>
                      </TimelineBody>
        ...
        <div className='w-full flex flex-col items-center mt-[70px]'>
          ...
          <div className='w-full flex flex-col justify-between gap-[15px] mt-[60px] border-[1px] border-[#212529] px-[40px] pb-[20px] bg-[#EFEFEF] font-bold text-[15px]'>
            {bookingPackage?.pricing.map((price, id) => {
              return (
                <div key={id}>
                  <p className='font-[600] text-[24px] mt-6'>{price.name}</p>
      ...
      <div className='flex flex-col-reverse lg:flex-row mt-10 gap-[50px]'>
        ...
        <div className='w-full lg:w-[400px] flex flex-col mt-[40px]'>
