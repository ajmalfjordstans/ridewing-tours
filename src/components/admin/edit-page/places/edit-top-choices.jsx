...
export default function EditPlace({ data, setShowEdit }) {
  ...
  const handleSave = async () => {
    try {
      ...
      const docRef = doc(db, 'countries/RzYea2pgV9rjQWRNuElX/top-choices/GO2xP38Ec7Vh9DksibdL');
  ...
  return (
    <div className='mt-[30px]'>
      <div className=' w-full flex flex-col '>
        <input type='text' className='font-bold text-[26px] md:text-[32px] leading-[42px] p-[5px] border-[1px] border-black rounded-[10px]' value={values?.name} />
