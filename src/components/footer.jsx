          ...
          <div className='container mx-auto flex justify-evenly items-center flex-col md:flex-row bg-[#EEB54C] py-[15px] max-h-[246px] rounded-[12px]'>
            ...
            <div className='hidden lg:block'>
              <div className='flex flex-col gap-1 md:gap-5 whitespace-nowrap text-[16px] md:text-[24px]'>
                <p className=' text-center'>Call Us now on <br /> {contact?.phone ? contact?.phone : "+44 (0) 208 432 432 5"}</p>
            ...
            <div className=' lg:hidden'>
              <div className='flex flex-col gap-1 md:gap-5 whitespace-nowrap text-[16px] md:text-[24px]'>
                <p className=' text-center'>Call Us now on: {contact?.phone ? contact?.phone : "+44 (0) 208 432 432 5"}</p>
                <p className=' text-center hover:cursor-pointer'
